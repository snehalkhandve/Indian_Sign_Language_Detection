...
def create_window():
    ...
    def text_2_img():
        ...
        for i in range(len(mtext)):
            if str(lis[i]) == "fine":
                ...
                img = cv2.imread("dataset\\train_gest\\help.jpg")
                height, width = img.shape[:2]
                ...
                img = cv2.imread("dataset\\train_gest\\I.jpg")
                height, width = img.shape[:2]
                ...
                img = cv2.imread("dataset\\train_gest\\make.jpg")
                height, width = img.shape[:2]
                ...
                img = cv2.imread("dataset\\train_gest\\me.jpg")
                height, width = img.shape[:2]
                ...
                img = cv2.imread("dataset\\train_gest\\please.jpg")
                height, width = img.shape[:2]
                ...
                cv2.waitKey(-1)
                cv2.destroyAllWindows()
            elif str(lis[i]) == "thanks":
                img = cv2.imread("P:\\python\\thanks\\thanksf.jpg")
                height, width = img.shape[:2]
    ...
    nbutton = Button(window, text='OK', command=text_2_img).pack()
